...
echo ""
echo "Setting up schema to load data into $NOLA311_DB_NAME on $NOLA311_DB_HOST"
echo ""
psql -U $NOLA311_DB_USER -d $NOLA311_DB_NAME -h $NOLA311_DB_HOST -f setup/setup_schema.sql

echo ""
echo "Loading data from $call_data_file"
echo "This may take a minute..."
echo ""
psql -U $NOLA311_DB_USER -d $NOLA311_DB_NAME -h $NOLA311_DB_HOST \
